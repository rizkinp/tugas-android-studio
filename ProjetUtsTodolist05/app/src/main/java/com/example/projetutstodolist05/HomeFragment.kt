...
//                addHistory(selectedTodo)
                ...
                Toast.makeText(requireContext(), "Ini adalah pesan toast", Toast.LENGTH_SHORT).show()
                dialog.dismiss()
            }
...
//        val lastCalculation = dbHelper.getLastCalculation()
//        if (lastCalculation != null) {
//            val history = "Result of ${lastCalculation.expression} is ${lastCalculation.result}"
